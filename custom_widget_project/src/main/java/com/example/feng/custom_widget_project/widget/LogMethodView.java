...
public class LogMethodView extends View {
    public LogMethodView(Context context) {
        super(context);
    }

    public LogMethodView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public LogMethodView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    public LogMethodView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
